    ...
    <div class="col-12">
        ...
        <div class="left-page">
            ...
            <form class="form1" action="/register" method="POST">
                ...
                <input class="form-control" id="uname" type="text" name="username" placeholder="Demo@123">
                </div>
                <div class="form-group">
                <label class="col-form-label" for="inputEmail3">Email Address</label>
                <input class="form-control" id="inputEmail3" type="email" name="email" placeholder="Demo@123gmail.com">
                </div>
                <div class="form-group">
                <label class="col-form-label" for="inputPassword3">Password</label><span> </span>
                <input class="form-control" id="inputPassword3" type="password" name="password" placeholder="Password">
                </div>
                <div class="form-group">
