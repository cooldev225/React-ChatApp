					...
					<div class="left-page">
						<div class="login-content">
							...
							<div class="form-group">
								...
								<input class="form-control" id="login-email" name="email" type="email" placeholder="Demo@123gmail.com" value="{{ old('email') }}">
								<!-- <span class="text-danger">{{ $errors->first('email') }}</span>                             -->
							</div>
							<div class="form-group">
								<label class="col-form-label" for="login-password">Password</label><span> </span>
								<input class="form-control" id="login-password" name="password" type="password" placeholder="Password" value="{{ old('password') }}">
