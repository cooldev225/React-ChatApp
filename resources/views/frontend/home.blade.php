            ...
            <div class="sidebar-main">
                ...
                <ul class="sidebar-bottom">
                    <li><a class="icon-btn btn-light button-effect mode" href="#" data-tippy-content="Theme Mode"
                            data-intro="Change mode"><i class="fa fa-moon-o"></i></a></li>
                    ...
                    <div class="theme-tab tab-sm chat-tabs">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" data-to="chat-content"><a class="nav-link button-effect active"
                                    ...
                                    aria-selected="true" data-intro="Start chat"><i data-feather="message-square">
                                    </i>Chat</a></li>
                                ...
                                <div class="collapse" id="collapseThree" aria-labelledby="headingThree"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p> <b>Note : </b>For added security, enable two-step verifiation, which will
                                            require a PIN when registering your phone number with Chitchat again.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="contact-name">
                                            ...
                                            <ul class="msg-box">
                                                <li class="msg-setting-main">
                                                    ...
                                                    <h5>Sure, chitchat is best theme for chating project, you can it check<a
                                                            class="ms-1"
